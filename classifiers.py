...
def ci_bootstrap_test(clf_name, optimised_clf, X, y, features_name,
    ...
    #         print ('{0}% CI: ({1}-{2})'.format(alpha, lower, upper))
    #
    #         if lower <= 0.0 and upper < 0.0:     # negative range
    #             if featimportance[i] <= lower and featimportance[i] >= upper:
    #                 print (' Yes')
    #             else:
    #                 print (' No')
    #         elif lower >= 0.0 and upper > 0.0:   # positive range
    #             if featimportance[i] >= lower and featimportance[i] <= upper:
    #                 print (' Yes')
    #             else:
    #                 print (' No')
    #         elif lower < 0.0 and upper > 0.0:    # negative positive range
    #             if featimportance[i] >= lower and featimportance[i] <= upper:
    #                 print (' Yes')
    #             else:
    #                 print (' No')
